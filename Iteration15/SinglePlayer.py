...
class OneTimeBlock(Block):
    def __init__(self,position,block_width):
        ...
        self.type = 'onetime'
        self.hit = 0
        self.image = pygame.image.load(os.path.join(PATH,"images","OneTime_Block.png")).convert_alpha()
    ...
    while not game_over:
        ...
        if player1.rect.y < SIZE[1]//3 and block_y > -10:
            ...
            if block_type == 'move':
                ...
                new_block = SpringBlock([block_x,block_y], block_width)
            block_group.add(new_block)
        ...
        if player1.rect.y < -SIZE[1]//6:
            block_y = move(20,block_y,all_sprites_group)
